        ...
        egui::SidePanel::left("MAIN")
            ...
            egui::CentralPanel::default().show(ctx, |ui| {
                ...
                if ui.button(egui::RichText::new("Bullshark Analysis\nViginere").font(FontId::monospace(24.0))).clicked() {
                    self.terminal1 = format!("Viginere\n{}\n\nBeaufort\n{}",bullshark_vigenere(&self.key1, &self.encrypted, &self.plaintext, self.key_length2), bullshark_beaufort(&self.key1, &self.encrypted, &self.plaintext, self.key_length2));
                }
